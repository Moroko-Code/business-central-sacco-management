...
Table 50334 "Payroll General Setup."
{
    fields
    {
        ...
        field(42; "Housing Levy Percentage"; Decimal)
        {

        }
        field(43; "Housing Levy relief %"; Decimal)
        {
        }
        field(44; "Pension Deduction %"; Decimal)
        {
        }
        field(45; "NSSF Lower Limit"; Decimal)
        {
        }
        field(46; "NSSF Upper Limit"; Decimal)
        {
        }
        field(47; "NHIF Relief %"; Decimal)
        {
        }
        field(48; "SHIF Percentage"; Decimal)
        {
        }
