table 50319 "Payroll Employee Transactions."
{
    ...
    fields
    {
        ...
        field(33; "Loan Number"; Code[20])
        {
            ...
            begin
                if loanReg.Get("Loan Number") then begin
                    loanReg.CalcFields(loanReg."Outstanding Balance");
                    if loanReg."Outstanding Balance" > 0 then begin
                        Amount := loanReg.Repayment;
                        rec.Modify;
                    end;
    ...
    begin
        ...
        if ObjLoans.Find('-') then begin
            ...
            if not FnLoanInterestExempted(LoanNo) then begin
                ...
                MESSAGE('%1 %2 %3 %4', (ObjLoans."Loan Product Type"), FORMAT(ObjLoans."Repayment Method"), ObjLoans."Approved Amount", ObjLoans."Outstanding Balance");
