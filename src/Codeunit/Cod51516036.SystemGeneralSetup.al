// codeunit 51516036 "System General Setup"
// {
//     var
...
//     local procedure MakeDateFilter2(var DateFilterText: Text[1024]): Integer
//     var
...
//     local procedure OnAfterMakeDateFilter()
//     begin
//     end;
...
//                 if LoansRegisterTable.Find('-') then
//                     if LoansRegisterTable."Loan Product Type" <> LoanProductType then;
...
//             end else
//                 if LoanOffsetTable.Find('-') = false then
