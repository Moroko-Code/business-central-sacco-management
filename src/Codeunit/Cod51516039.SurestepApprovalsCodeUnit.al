...
Codeunit 51516039 "SurestepApprovalsCodeUnit"
{
    trigger OnRun()
    begin
    end;
    ...
    begin
        if FnCheckIfMembershipApplicationApprovalsWorkflowEnabled("Membership Applications") then
    ...
    begin
        if FnCheckIfLoanApplicationApprovalsWorkflowEnabled("Loans Register") then
    ...
    begin
        if FnCheckIfBOSATransApprovalsWorkflowEnabled("BOSA Transfers") then
    ...
    begin
        if FnCheckIfLoanBatchApprovalsWorkflowEnabled("Loan Disburesment-Batching") then
    ...
    begin
        if FnCheckIfLoanTopUpApprovalsWorkflowEnabled("Loan Top Up.") then
    ...
    begin
        if FnCheckIfMemberChangeRequestApprovalsWorkflowEnabled("Change Request") then
    ...
    begin
        if FnCheckIfMemberMemberReapplicationApprovalsWorkflowEnabled(MemberReapplication) then
    ...
    begin
        if FnCheckIfMembershipExitApplicationApprovalsWorkflowEnabled("Membership Exist") then
    ...
    begin
        if FnCheckIfGuarantorSubApprovalsWorkflowEnabled("Guarantorship Substitution H") then
    ...
    begin
        if FnCheckIfPaymentVoucherApprovalsWorkflowEnabled("Payment Header") then
    ...
    begin
        if FnCheckIfPettyCashReimbersementApprovalsWorkflowEnabled("Funds Transfer Header") then
    ...
    begin
        if FnCheckIfFOSAProductApplicationApprovalsWorkflowEnabled("Accounts Applications Details") then
    ...
    begin
        if FnCheckIfLoanRecoveryApplicationApprovalsWorkflowEnabled("Loan Recovery Header") then
