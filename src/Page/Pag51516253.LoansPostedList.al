...
Page 51516253 "Loans Posted List"
{
    ...
    layout
    {
        area(content)
        {
            repeater(Control1000000000)
            {
                ...
                field("Recommended Repayment "; Rec."Recommended Repayment")
                {
                    ToolTip = 'Specifies the value of the Recommended Repayment  field.', Comment = '%';
                }
    ...
    // Testing expression which needs condition.
