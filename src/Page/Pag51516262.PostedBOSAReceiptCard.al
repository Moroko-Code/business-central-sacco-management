...
Page 51516262 "Posted BOSA Receipt Card"
{
    DeleteAllowed = true;
    Editable = true;
    InsertAllowed = false;
                        ...
                        if "Account Type" = "account type"::Customer then begin
                                ...
                                if RunBal > 0 then begin
                                    ...
                                    if Loans.Find('-') then
                                        repeat
                                            ...
                                            //Insurance Charge
                                            Loans.CalcFields(Loans."Outstanding Balance", Loans."Interest Due", Loans."Loans Insurance");
                            ...
                            if Cust.Get("Account No.") then begin
                                ...
                                if Cust."Shares Retained" < 5000 then begin
                                    BosaSetUp.Get();
                                    if BosaSetUp."Monthly Share Contributions" > 0 then;
