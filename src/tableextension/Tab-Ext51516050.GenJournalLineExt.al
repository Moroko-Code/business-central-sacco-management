tableextension 51516050 "GenJournalLineExt" extends "Gen. Journal Line"
{
    fields
    {
        ...
        {
            TableRelation = if ("Transaction Type" = filter(Repayment | Loan | "Interest Due" | "Interest Paid")) "Loans Register"."Loan  No." where("Client Code" = field("Account No."),
    ...
    begin
        ...
        case AccType of
            ...
            Acctype::Vendor:
                if xRec."Applies-to ID" <> '' then begin
                    if FindFirstVendLedgEntryWithAppliesToID(AccNo, xRec."Applies-to ID") then
