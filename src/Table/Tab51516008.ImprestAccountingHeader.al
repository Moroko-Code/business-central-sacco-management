...
Table 51516008 "Imprest Accounting Header"
{
    // DrillDownPageID = UnknownPage39004030;
    // LookupPageID = UnknownPage39004030;
    ...
    fields
    {
        ...
        field(87; "Account No."; Code[20])
        {
            Caption = 'Account No.';
            Editable = true;
            TableRelation = Customer."No." where("Customer Posting Group" = filter('STAFF' | 'IMPREST'));
        ...
        {
            OptionCaption = ' ,Imprest,Advance';
            OptionMembers = " ",Imprest,Advance;
        }
        field(91; "Employee Job Group"; Code[10])
        {
            Editable = false;
            TableRelation = "Employee Statistics Group";
        }
        field(92; "PF No."; Code[10])
        {
            Description = 'Stores the Payroll No. of  Staff';
        }
    }
    ...
    var
        ...
        Pline: Record "Imprest Accounting Lines";
        CurrExchRate: Record "Currency Exchange Rate";
        ImpLines: Record "Imprest Accounting Lines";
        UserSetup: Record "User Setup";

    procedure UpdateHeaderToLine()
    var
        PayLine: Record "Imprest Accounting Lines";
    begin
        PayLine.Reset;
