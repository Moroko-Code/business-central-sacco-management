...
Table 51516031 "Funds User Setup"
{
    fields
    {
        ...
        field(12; "Receipt Journal Batch"; Code[20])
        {
            ...
            begin
                ...
                if UserTemp.FindFirst then
                    repeat
                        if (UserTemp.UserID <> UserID) and ("Receipt Journal Batch" <> '') then
        ...
        field(18; "FundsTransfer Batch Name"; Code[20])
        {
            ...
            begin
                ...
                if UserTemp.FindFirst then
                    repeat
                        if (UserTemp.UserID <> Rec.UserID) and ("FundsTransfer Batch Name" <> '') then
                            Error(SameBatch, "Receipt Journal Batch", "Petty Cash Batch");
                    until UserTemp.Next = 0;
            end;
        }
        ...
        field(45; "Salaries Batch"; Code[20])
        {
            ...
            begin
                ...
                if UserTemp.FindFirst then
                    repeat
                        if (UserTemp.UserID <> Rec.UserID) and ("Salaries Batch" <> '') then
