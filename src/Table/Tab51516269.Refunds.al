...
Table 51516269 "Refunds"
{
    fields
    {
        ...
        field(3; Amount; Decimal)
        {
            ...
            begin
                ...
                if Amount <> 0 then begin
                    ...
                    if "Transaction Type" = "transaction type"::"Shares Contribution" then
                        if Cust.Get("Member No.") then begin
                    ...
                    if "Transaction Type" = "transaction type"::Interest then
                        if Loans.Get("Loan No.") then begin
        ...
        {
            // TableRelation = if ("Transaction Type"=const(Repayment)) "Absence Preferences"."Include Weekends" where (Field4=field("Member No."))
