...
Table 51516234 "Loan Repayment Schedule"
{
    fields
    {
        ...
        field(53; "Repayment Day"; Integer)
        {
        }
        field(54; "Repayment Month"; Integer)
        {
        }
        field(55; "Repayment Year"; Integer)
        {
        }
        field(56; "Loan Balance"; Decimal)
        {
        }
        field(57; "Top Up Code"; Code[10])
        {
        }
        field(58; "Active Schedule"; Boolean)
        {
        }
    }
