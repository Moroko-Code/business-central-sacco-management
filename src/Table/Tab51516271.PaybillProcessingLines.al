...
Table 51516271 "Paybill Processing Lines"
{
    fields
    {
        ...
        field(20; "Loan No"; Code[20])
        {
            ...
            begin
                ...
                if memb.Find('-') then begin
                    ...
                    if loans.Find('-') then
                        if "Trans Type" = "trans type"::sInsurance then
                            Amount := 100
                        else if "Trans Type" = "trans type"::sDeposits then begin
                        ...
                        end else if "Trans Type" = "trans type"::sLoan then
        ...
        {
            //TableRelation = Table39004254.Field1;
        }
        field(25; "Member No"; Code[20])
        {
            ...
            begin
                ...
                if memb.Find('-') then begin
                    ...
                    if "Trans Type" = "trans type"::sShare then
                        Amount := memb."Monthly Contribution"
                    else if "Trans Type" = "trans type"::sInterest then
                        Amount := 200
                    else if "Trans Type" = "trans type"::sInsurance then
                        Amount := 100
                    else if "Trans Type" = "trans type"::sBenevolent then;
        ...
        {
            TableRelation = "Paybill Processing Header".No;
        }
        ...
        field(31; "Mobile No"; Code[20])
        {
        }
        field(32; "Transaction No"; Code[25])
        {
        }
    }
