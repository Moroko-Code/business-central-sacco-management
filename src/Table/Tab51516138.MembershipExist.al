...
Table 51516138 "Membership Exist"
{
    fields
    {
        field(1; "No."; Code[20])
        ...
        field(2; "Member No."; Code[20])
        {
            ...
            begin
                ...
                Closure.Reset;
                Closure.SetRange("Member No.", "Member No.");
                Closure.SetRange("Member Name", ExitingMember);
                Closure.SetFilter("No.", '<>%1', "No.");
                Closure.SetRange(Posted, false);
                if Closure.FindSet then
                ...
                if Cust.Get("Member No.") then begin
                    ...
                    Payee := Cust.Name;
                    Cust.CalcFields(Cust."Current Shares", cust."Outstanding Balance", Cust."Shares Retained");
                    ...
                    if "Sell Share Capital" = false then
        ...
        field(30; "Sell Share Capital to"; Code[20])
        {
            ...
            trigger OnValidate()
            begin
                if Cust.Get("Sell Share Capital to") then
