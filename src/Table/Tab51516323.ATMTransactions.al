...
Table 51516323 "ATM Transactions"
{
    fields
    {
        ...
        {
            OptionCaption = 'ATM Bridge,MSacco';
            OptionMembers = "ATM Bridge",MSacco;
        }
        ...
        {
            OptionCaption = 'ATM Lobby,Agent Banking,Coop Branch,Sacco POS';
