...
Table 51516270 "Paybill Processing Header"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = sum("Paybill Processing Lines".Amount where("Receipt Header No" = field(No)));
            Editable = false;
            FieldClass = FlowField;
        }
        field(27; "Total Count"; Integer)
        {
            CalcFormula = count("Paybill Processing Lines" where("Receipt Header No" = field(No)));
            FieldClass = FlowField;
        }
        field(28; "Account Name"; Code[60])
        {
        }
