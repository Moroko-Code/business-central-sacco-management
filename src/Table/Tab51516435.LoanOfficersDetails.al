...
// Table 51516435 "Loan Officers Details"
// {
//     fields
//     {
...
//         {
//             // TableRelation = if ("Sales Code Type" = const(Staff))
//             // else
...
//         {
//             Caption = 'Account No.';
//             TableRelation = if ("Account Type" = const(Staff)) "HR Employee"
//             else
...
//         {
//         }
//         field(21; "Name Used"; Text[50])
//         {
//         }
//         field(22; "Savings Collected"; Decimal)
//         {
//             CalcFormula = - sum("Cust. Ledger Entry"."Amount Posted" where("BLoan Officer No." = field("Account No."),
//                                                                    "Transaction Type" = filter("Deposit Contribution"),
//                                                                    "Customer Posting Group" = const('MICRO')));
//             Editable = false;
//             FieldClass = FlowField;
//         }
//         field(23; "Loans Recovered"; Decimal)
//         {
//             CalcFormula = - sum("Cust. Ledger Entry"."Amount Posted" where("BLoan Officer No." = field("Account No."),
//                                                                    "Customer Posting Group" = const('MICRO'),
...
//     fieldgroups
//     {
//         fieldgroup(DropDown; "Account Name", Name)
//         {
//         }
//     }
