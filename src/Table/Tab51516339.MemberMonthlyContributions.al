...
Table 51516339 "Member Monthly Contributions"
{
        ...
        field(2; Type; Option)
        {
            ...
            begin
                if Type = Type::"Registration Fee" then begin
                    ...
                    if Type = Type::Loan then
                        Descripition := 'Loan Repayment'
                    else
                        if Type = Type::"Benevolent Fund" then
                            Descripition := 'BBF'
                        else
                            if Type = Type::"Interest Due" then
                                Descripition := 'Interest Due'
                            else
                                if Type = Type::"Interest Paid" then
                                    Descripition := 'Interest Paid'
                                else
                                    if Type = Type::"FOSA Account" then
                                        Descripition := 'Interest Paid'
                                    else
                                        if Type = Type::"Deposit Contribution" then
