...
Table 51516137 "Next of Kin/Account Sign"
{
    //nownPage51516364;
    //nownPage51516364;
    ...
    fields
    {
        ...
        {
            CalcFormula = sum("Members Next Kin Details"."%Allocation" where("Account No" = field("Account No")));
    ...
    var
        NomineeApp: Record "Members Next Kin Details";
