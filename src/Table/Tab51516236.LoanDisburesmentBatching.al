...
Table 51516236 "Loan Disburesment-Batching"
{
    ...
    fields
    {
        ...
        field(8; "Prepared By"; Code[50])
        {
        }
        field(9; Date; Date)
        {
        }
        field(10; "Mode Of Disbursement"; Enum "Mode Of Disbursement")
        {
            trigger OnValidate()
            begin
            end;
        ...
        {
            TableRelation = if (Housing = const(false)) "Bank Account"."No."
            else
            if (Housing = const(true)) Customer."No.";
        ...
        field(31; "Total Net Loans Disbursed"; Decimal)
        {
            CalcFormula = sum("Loans Register"."Net Loan Disbursed" where("Batch No." = field("Batch No.")));
            FieldClass = FlowField;
        }
        field(32; "Net Loan Disbursed"; Decimal)
        {
        }
        field(33; Housing; Boolean)
        {
            trigger OnValidate()
            begin
