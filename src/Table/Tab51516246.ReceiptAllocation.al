    ...
    fields
    {
        ...
        field(4; "Loan No."; Code[20])
        {
            ...
            begin
                ...
                if Loans.Get("Loan No.") and ("Transaction Type" = "transaction type"::Repayment) then begin
        ...
        field(5; Amount; Decimal)
        {
            trigger OnValidate()
            begin
                if (("Transaction Type" = "transaction type"::"Interest Paid") or ("Transaction Type" = "transaction type"::Loan) or ("Transaction Type" = "transaction type"::Repayment)) then
                    if "Loan No." = '' then
        ...
        field(51516160; "Account No"; Code[100])
        {
            ...
            begin
                ...
                if "Account Type" = "account type"::Vendor then
                    if ObjAccount.Get("Account No") then
