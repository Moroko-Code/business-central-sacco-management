...
Report 51516883 "System Change Entry Log"
{
    DefaultLayout = RDLC;
    Caption = 'System Change Entry Log';
    RDLCLayout = './Layouts/System Read Log.rdl';
    ...
    dataset
    {
        dataitem("Session Event"; "System Log Trails")
        {
            ...
            DataItemTableView = sorting("Entry No") where("Session Type" = filter(Read | Modify | Delete));
            ...
            column(Transaction_Description; "Session Event"."Page Viewed")
            {
            }
