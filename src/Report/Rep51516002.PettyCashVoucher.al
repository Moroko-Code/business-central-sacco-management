...
Report 51516002 "PettyCash Voucher"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/PettyCash Voucher.rdlc';
    ...
    dataset
    {
        dataitem("Payment Header"; "Payment Header")
        {
            ...
            // dataitem(UnknownTable55920;UnknownTable55920)
            // {
            //     DataItemLink = Field2=field("No.");
            //     DataItemTableView = sorting(Field10) order(ascending) where(Field1=const(0));
