...
//51516298_v6_3_0_2259)

Report 51516354 "Approval Details"
{
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = './Layouts/ApprovalDetails.rdl';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = where("Document Type" = filter(LoanApplication | LoanDisbursement));
