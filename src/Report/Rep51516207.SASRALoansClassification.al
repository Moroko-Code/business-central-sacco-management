    ...
    dataset
    {
        dataitem("Loans Register"; "Loans Register")
        {
            ...
            begin
                ...
                LoansReg.SetAutocalcFields(LoansReg."Scheduled Principle Payments", LoansReg."Schedule Loan Amount Issued", LoansReg."Schedule Installments", LoansReg."Outstanding Balance",LoansReg."Scheduled Interest Payments", LoansReg."Interest Paid");
                if LoansReg.Find('-') then begin
                    ...
                    if LoansReg.Source = LoansReg.Source::BOSA then begin
                        ...
                        if (LoansReg."Expected Date of Completion" <> 0D) then
                    ...
                    if (PerformingDisplay = 0) and (WatchDisplay = 0) and (StandardDisplay = 0)
                      and (DoubtfulDisplay = 0) and (LossDisplay = 0) OR (LoansReg."Schedule Installments" = 0) then
                        CurrReport.Skip;
