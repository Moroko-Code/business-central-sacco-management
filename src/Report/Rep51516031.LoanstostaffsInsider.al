...
Report 51516031 "Loans to staffs-Insider"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Loanstostaffs-Insider.rdlc';

    dataset
    {
        dataitem("Loans Register"; "Loans Register")
        {
            DataItemTableView = where("Insider Lending" = filter(true), "Outstanding Balance" = filter(> 0));
