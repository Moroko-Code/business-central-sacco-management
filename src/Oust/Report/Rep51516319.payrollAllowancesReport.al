...
Report 51516319 "payroll Allowances Report."
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layout/payroll Allowances Report..rdlc';
    ...
    var
        ...
        PeriodTrans: Record "Change MPESA Transactions";
        GroupOrder: label '3';
        ...
        Dept: Boolean;
        PrevMonth: Decimal;
        PeriodTrans2: Record "Change MPESA Transactions";
