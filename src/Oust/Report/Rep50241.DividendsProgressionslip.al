...
//.6.3.0.2259")
//_6_3_0_2259; ForNavReport51516241_v6_3_0_2259)
...
Report 50241 "Dividends Progressionslip"
{
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            column(Members__Payroll_Staff_No_; Customer."Payroll/Staff No")
            {
            }
            ...
            dataitem("Dividends Progression"; "Dividends Progression")
            {
                ...
                column(Dividends_Progression__Net_Dividends_; "Net Dividends")
                {
                }
                column(Dividends_Progression__Qualifying_Shares_; "Qualifying Shares")
                {
                }
                ...
                column(TotalGrossDividend; ("Dividends Progression"."Gross Interest On Deposit" + "Gross Dividends"))
                {
                }
